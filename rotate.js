!(function () {
    ...
    function c(t) {
        return [
            Math.atan2(2 * (t[0] * t[1] + t[2] * t[3]), 1 - 2 * (t[1] * t[1] + t[2] * t[2])) * h,
            Math.asin(Math.max(-1, Math.min(1, 2 * (t[0] * t[2] - t[3] * t[1])))) * h,
            Math.atan2(2 * (t[0] * t[3] + t[1] * t[2]), 1 - 2 * (t[2] * t[2] + t[3] * t[3])) * h,
        ];
    }
    function i(t) {
        var n = t[0] * d,
                    ...
                    if (o !== t) {
                        o.each("start.zoom", function () {
                            ...
                            .tween("zoom:zoom", function () {
                                ...
                                return (
                                    f && o.duration(f(0.001 * u.duration)),
                                    function (e) {
                                        var a = u(e);
                                        (this.__chart__ = z = { r: c(i(a[0] / s)), k: t / a[2] }), h.rotate(z.r).scale(z.k), m.scale(z.k), l(n);
                                    }
                                );
                            })
    ...
    (function () {
                    ...
                    .on("mousedown.grab", function () {
                        ...
                        e &&
                            (n = t
                                ...
                                .datum({ type: "Point", coordinates: a.invert(d3.mouse(this)) })
                                .attr("class", "point")
                                .attr("d", o));
        ...
        var e = 180 / Math.PI,
            ...
            c = -1;
        d3
            .selectAll("#map, #eisenlohr")
            .data([
                n(a, o)
                    .scale(245)
                    .translate([a / 2, 0.56 * o]),
                d3.geo
                    .eisenlohr()
                    .precision(0.1)
                    .clipExtent([
            ...
            .each(function (n) {
                ...
                a.selectAll(".foreground").call(
                    d3.geo
                        .zoom()
                        .projection(n)
                        .scaleExtent([0.7 * n.scale(), 10 * n.scale()])
